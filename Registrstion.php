...
<body>
  ...
  <div class="main" style="height: max-content;">
    <div style="display: flex;justify-content: center;"><h2>Course Registration</h2></div>
    <div class="sub" style="display: flex;justify-content: center;">
      <ul>
        <li><a href="CourseReg.php">Register Courses</a></li>
        <li><a href="showcourses.php">Show Registered Courses</a></li>
