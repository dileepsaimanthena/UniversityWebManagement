...
<body>
  ...
  <div class="main">
    <div class="sub" style="display:flex;flex-direction:column;justify-content:center;align-items:center;">
      <h1 style="text-align:center;color: #3CB371">Attendance successfuly submitted</h1>
      <i style="font-size:40px;color: #3CB371"  class="bi bi-check-circle"></i>
    </div>
  </div>
